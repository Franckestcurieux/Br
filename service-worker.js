...
var CACHE_NAME = 'conjugacao-pt-iota36';
...
var ASSETS_TO_CACHE = [
  ...
  './js/data.js?v=iota36',
  './js/core.js?v=iota36',
  './js/engine.js?v=iota36',
  './js/ui-selection.js?v=iota36',
  './js/ui-ref.js?v=iota36',
  './js/voice.js?v=iota36',
  './js/stats.js?v=iota36',
  './js/stats-ui.js?v=iota36',
  './js/tts.js?v=iota36',
  './js/router.js?v=iota36',
  './js/splash.js?v=iota36',
  './js/mode-erreurs.js?v=iota36',
  './js/init.js?v=iota36',
  './js/i18n.js?v=iota36',
  './data/verbs.json',
  './data/meta.json',
