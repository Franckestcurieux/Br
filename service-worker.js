...
var CACHE_NAME = 'conjugacao-pt-iota26';
...
var ASSETS_TO_CACHE = [
  ...
  './js/data.js?v=iota26',
  './js/core.js?v=iota26',
  './js/engine.js?v=iota26',
  './js/ui-selection.js?v=iota26',
  './js/ui-ref.js?v=iota26',
  './js/voice.js?v=iota26',
  './js/stats.js?v=iota26',
  './js/stats-ui.js?v=iota26',
  './js/tts.js?v=iota26',
  './js/router.js?v=iota26',
  './js/splash.js?v=iota26',
  './js/mode-erreurs.js?v=iota26',
  './js/init.js?v=iota26',
  './js/i18n.js?v=iota26',
  './data/verbs.json',
  './data/meta.json',
