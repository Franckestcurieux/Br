...
var CACHE_NAME = 'conjugacao-pt-iota46';
...
var ASSETS_TO_CACHE = [
  ...
  './js/data.js?v=iota46',
  './js/core.js?v=iota46',
  './js/engine.js?v=iota46',
  './js/ui-selection.js?v=iota46',
  './js/ui-ref.js?v=iota46',
  './js/voice.js?v=iota46',
  './js/stats.js?v=iota46',
  './js/stats-ui.js?v=iota46',
  './js/tts.js?v=iota46',
  './js/router.js?v=iota46',
  './js/splash.js?v=iota46',
  './js/mode-erreurs.js?v=iota46',
  './js/init.js?v=iota46',
  './js/i18n.js?v=iota46',
  './data/verbs.json',
  './data/meta.json',
