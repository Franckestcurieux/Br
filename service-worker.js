...
var CACHE_NAME = 'conjugacao-pt-iota30';
...
var ASSETS_TO_CACHE = [
  ...
  './js/data.js?v=iota30',
  './js/core.js?v=iota30',
  './js/engine.js?v=iota30',
  './js/ui-selection.js?v=iota30',
  './js/ui-ref.js?v=iota30',
  './js/voice.js?v=iota30',
  './js/stats.js?v=iota30',
  './js/stats-ui.js?v=iota30',
  './js/tts.js?v=iota30',
  './js/router.js?v=iota30',
  './js/splash.js?v=iota30',
  './js/mode-erreurs.js?v=iota30',
  './js/init.js?v=iota30',
  './js/i18n.js?v=iota30',
  './data/verbs.json',
  './data/meta.json',
