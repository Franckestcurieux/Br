...
var CACHE_NAME = 'conjugacao-pt-iota39';
...
var ASSETS_TO_CACHE = [
  ...
  './js/data.js?v=iota39',
  './js/core.js?v=iota39',
  './js/engine.js?v=iota39',
  './js/ui-selection.js?v=iota39',
  './js/ui-ref.js?v=iota39',
  './js/voice.js?v=iota39',
  './js/stats.js?v=iota39',
  './js/stats-ui.js?v=iota39',
  './js/tts.js?v=iota39',
  './js/router.js?v=iota39',
  './js/splash.js?v=iota39',
  './js/mode-erreurs.js?v=iota39',
  './js/init.js?v=iota39',
  './js/i18n.js?v=iota39',
  './data/verbs.json',
  './data/meta.json',
