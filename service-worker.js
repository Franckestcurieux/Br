...
var CACHE_NAME = 'conjugacao-pt-iota44';
...
var ASSETS_TO_CACHE = [
  ...
  './js/data.js?v=iota44',
  './js/core.js?v=iota44',
  './js/engine.js?v=iota44',
  './js/ui-selection.js?v=iota44',
  './js/ui-ref.js?v=iota44',
  './js/voice.js?v=iota44',
  './js/stats.js?v=iota44',
  './js/stats-ui.js?v=iota44',
  './js/tts.js?v=iota44',
  './js/router.js?v=iota44',
  './js/splash.js?v=iota44',
  './js/mode-erreurs.js?v=iota44',
  './js/init.js?v=iota44',
  './js/i18n.js?v=iota44',
  './data/verbs.json',
  './data/meta.json',
