...
var CACHE_NAME = 'conjugacao-pt-iota24';
...
var ASSETS_TO_CACHE = [
  ...
  './js/data.js?v=iota24',
  './js/core.js?v=iota24',
  './js/engine.js?v=iota24',
  './js/ui-selection.js?v=iota24',
  './js/ui-ref.js?v=iota24',
  './js/voice.js?v=iota24',
  './js/stats.js?v=iota24',
  './js/stats-ui.js?v=iota24',
  './js/tts.js?v=iota24',
  './js/router.js?v=iota24',
  './js/splash.js?v=iota24',
  './js/mode-erreurs.js?v=iota24',
  './js/init.js?v=iota24',
  './js/i18n.js?v=iota24',
  './data/verbs.json',
  './data/meta.json',
