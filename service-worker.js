...
var CACHE_NAME = 'conjugacao-pt-iota45';
...
var ASSETS_TO_CACHE = [
  ...
  './js/data.js?v=iota45',
  './js/core.js?v=iota45',
  './js/engine.js?v=iota45',
  './js/ui-selection.js?v=iota45',
  './js/ui-ref.js?v=iota45',
  './js/voice.js?v=iota45',
  './js/stats.js?v=iota45',
  './js/stats-ui.js?v=iota45',
  './js/tts.js?v=iota45',
  './js/router.js?v=iota45',
  './js/splash.js?v=iota45',
  './js/mode-erreurs.js?v=iota45',
  './js/init.js?v=iota45',
  './js/i18n.js?v=iota45',
  './data/verbs.json',
  './data/meta.json',
