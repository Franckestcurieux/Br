...
var CACHE_NAME = 'conjugacao-pt-iota42';
...
var ASSETS_TO_CACHE = [
  ...
  './js/data.js?v=iota42',
  './js/core.js?v=iota42',
  './js/engine.js?v=iota42',
  './js/ui-selection.js?v=iota42',
  './js/ui-ref.js?v=iota42',
  './js/voice.js?v=iota42',
  './js/stats.js?v=iota42',
  './js/stats-ui.js?v=iota42',
  './js/tts.js?v=iota42',
  './js/router.js?v=iota42',
  './js/splash.js?v=iota42',
  './js/mode-erreurs.js?v=iota42',
  './js/init.js?v=iota42',
  './js/i18n.js?v=iota42',
  './data/verbs.json',
  './data/meta.json',
