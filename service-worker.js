...
var CACHE_NAME = 'conjugacao-pt-iota21';
...
var ASSETS_TO_CACHE = [
  ...
  './js/data.js?v=iota21',
  './js/core.js?v=iota21',
  './js/engine.js?v=iota21',
  './js/ui-selection.js?v=iota21',
  './js/ui-ref.js?v=iota21',
  './js/voice.js?v=iota21',
  './js/stats.js?v=iota21',
  './js/stats-ui.js?v=iota21',
  './js/tts.js?v=iota21',
  './js/router.js?v=iota21',
  './js/splash.js?v=iota21',
  './js/mode-erreurs.js?v=iota21',
  './js/init.js?v=iota21',
  './js/i18n.js?v=iota21',
  './data/verbs.json',
  './data/meta.json',
