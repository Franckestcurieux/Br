...
var CACHE_NAME = 'conjugacao-pt-iota18';
...
var ASSETS_TO_CACHE = [
  ...
  './js/data.js?v=iota18',
  './js/core.js?v=iota18',
  './js/engine.js?v=iota18',
  './js/ui-selection.js?v=iota18',
  './js/ui-ref.js?v=iota18',
  './js/voice.js?v=iota18',
  './js/stats.js?v=iota18',
  './js/stats-ui.js?v=iota18',
  './js/tts.js?v=iota18',
  './js/router.js?v=iota18',
  './js/splash.js?v=iota18',
  './js/mode-erreurs.js?v=iota18',
  './js/init.js?v=iota18',
  './js/i18n.js?v=iota18',
  './data/verbs.json',
  './data/meta.json',
