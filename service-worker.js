...
var CACHE_NAME = 'conjugacao-pt-iota38';
...
var ASSETS_TO_CACHE = [
  ...
  './js/data.js?v=iota38',
  './js/core.js?v=iota38',
  './js/engine.js?v=iota38',
  './js/ui-selection.js?v=iota38',
  './js/ui-ref.js?v=iota38',
  './js/voice.js?v=iota38',
  './js/stats.js?v=iota38',
  './js/stats-ui.js?v=iota38',
  './js/tts.js?v=iota38',
  './js/router.js?v=iota38',
  './js/splash.js?v=iota38',
  './js/mode-erreurs.js?v=iota38',
  './js/init.js?v=iota38',
  './js/i18n.js?v=iota38',
  './data/verbs.json',
  './data/meta.json',
