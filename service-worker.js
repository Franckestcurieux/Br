...
var CACHE_NAME = 'conjugacao-pt-iota32';
...
var ASSETS_TO_CACHE = [
  ...
  './js/data.js?v=iota32',
  './js/core.js?v=iota32',
  './js/engine.js?v=iota32',
  './js/ui-selection.js?v=iota32',
  './js/ui-ref.js?v=iota32',
  './js/voice.js?v=iota32',
  './js/stats.js?v=iota32',
  './js/stats-ui.js?v=iota32',
  './js/tts.js?v=iota32',
  './js/router.js?v=iota32',
  './js/splash.js?v=iota32',
  './js/mode-erreurs.js?v=iota32',
  './js/init.js?v=iota32',
  './js/i18n.js?v=iota32',
  './data/verbs.json',
  './data/meta.json',
