...
var CACHE_NAME = 'conjugacao-pt-iota37';
...
var ASSETS_TO_CACHE = [
  ...
  './js/data.js?v=iota37',
  './js/core.js?v=iota37',
  './js/engine.js?v=iota37',
  './js/ui-selection.js?v=iota37',
  './js/ui-ref.js?v=iota37',
  './js/voice.js?v=iota37',
  './js/stats.js?v=iota37',
  './js/stats-ui.js?v=iota37',
  './js/tts.js?v=iota37',
  './js/router.js?v=iota37',
  './js/splash.js?v=iota37',
  './js/mode-erreurs.js?v=iota37',
  './js/init.js?v=iota37',
  './js/i18n.js?v=iota37',
  './data/verbs.json',
  './data/meta.json',
