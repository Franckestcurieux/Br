...
var CACHE_NAME = 'conjugacao-pt-iota27';
...
var ASSETS_TO_CACHE = [
  ...
  './js/data.js?v=iota27',
  './js/core.js?v=iota27',
  './js/engine.js?v=iota27',
  './js/ui-selection.js?v=iota27',
  './js/ui-ref.js?v=iota27',
  './js/voice.js?v=iota27',
  './js/stats.js?v=iota27',
  './js/stats-ui.js?v=iota27',
  './js/tts.js?v=iota27',
  './js/router.js?v=iota27',
  './js/splash.js?v=iota27',
  './js/mode-erreurs.js?v=iota27',
  './js/init.js?v=iota27',
  './js/i18n.js?v=iota27',
  './data/verbs.json',
  './data/meta.json',
